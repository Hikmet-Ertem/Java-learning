...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        // 012345678
        String text = "Good";
        System.out.println("G harfinin indexi = " + text.indexOf("G")); // indexler 0 dan baÅŸlar
        System.out.println("d harfinin indexi = " + text.indexOf('d')); //3
        System.out.println("H harfinin indexi = " + text.indexOf("H")); // -1  : bulunamadÄ±, yok
        System.out.println("od nin indexi = " + text.indexOf("od")); // 2 : var ise ilk harfin indexini verir
        int index = text.indexOf("o"); // int deÄŸiÅŸkene atanabilir. kÃ¼Ã§Ã¼k o harfi
        System.out.println("index = " + index); // 1 :  aynÄ± karakterden birden fazla var ise ilkini verir.
        ...
        /** lastIndexOf()
         *  String iÃ§inde aranan karakter(ler)in sondan itibaren ilk indexini varÄ±r
         *  indexOf un sondan olan hali fakat index numaralarÄ± deÄŸiÅŸmez.
         */
        ...
        System.out.println("ilk baÅŸtan i nun indexi = " + textt.indexOf("i")); //6
        System.out.println("----------");
        /**
         * charAt()
         * Ä°stenen noktadaki karakteri verir,
         * karakterlerin sÄ±rasÄ± 0 dan baÅŸlar, buna index denir.
        ...
        /** ReplaceFirst
        * Replace ile aynÄ± sadece ilk bulunanÄ± deÄŸiÅŸtirir
         */
        String txt = "Merhaba Dunya";

        System.out.println("orjinal hali = " + txt); //orjinal hali = Merhaba Dunya
        System.out.println("butun a larÄ±n nÄ±n degistigi hali = " + txt.replace("a", "e"));
        // butun a larÄ±n nÄ±n degistigi hali = Merhebe Dunye
        System.out.println("ilk bulunan a nÄ±n degistigi hali = " + txt.replaceFirst("a", "e"));
        // ilk bulunan a nÄ±n degistigi hali = Merheba Dunya
        System.out.println("----------");
        /** replaceAll()
         *
         */
         ...
         * bir stringin iÃ§erisinde karakter(ler)in var olup olmadÄ±ÄŸÄ±nÄ± kontrol eder.
         * Sonuc boolean dir.
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. bÃ¼yÃ¼k kÃ¼Ã§Ã¼k harf farkÄ± vardÄ±r. Sonuc boolean dir.
         *
         * equalsIgnorecase()
        ...
        System.out.println("EÅŸit mi = " + str.equalsIgnoreCase("mERHaba")); // true
        System.out.println("EÅŸit mi = " + str.equalsIgnoreCase("mERHa")); // false
    ...
    * bir stringe diÄŸerini ekler
     ...
     * */
        ...
        s = s.concat(s2);// yani degiskenin kendisine atama yapÄ±lÄ±rsa degeri kalici degisir.
        // s= s+s2; aynÄ± islemi yapar.
        System.out.println("s = " + s); // s = Hi everybody
        System.out.println("----------");
        /**
         * StringIsEmpty
         *  String tamamen boÅŸ mu deÄŸil mi onu kontrol ediyor, sonuÃ§ true false
         */
        String str1 = "Hi";
        System.out.println("str1 iÃ§i boÅŸ mu = " + str1.isEmpty()); //false

        String str2 = "";
        System.out.println("str2 iÃ§i boÅŸ mu = " + str2.isEmpty()); //true

        String str3 = " ";
        System.out.println("str3 iÃ§i boÅŸ mu = " + str3.isEmpty());  //false
        boolean bosMu = str3.isEmpty(); // boolean deÄŸiÅŸkenine atanabilir.
        ...
        System.out.println(str4.toUpperCase()); //TECHPROEDUCATÄ°ON
        ...
        System.out.println(str4);  //TECHPROEDUCATÄ°ON
         ...
         */
        String cumle = "Bu gÃ¼n hava yagmurlu";
